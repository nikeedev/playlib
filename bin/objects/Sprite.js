...
var Sprite = /** @class */ (function (_super) {
    ...
    function Sprite(imageSrc, position, screenSize) {
    ...
    Sprite.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadImage(this.imageSrc)];
                    case 1:
                        img = _a.sent();
    ...
    Sprite.prototype.draw = function (ctx, imageSize, clipPos, clipSize) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (this.image != undefined) {
                    ...
                    console.info("Sprite \"".concat(this.imageSrc, "\" is loading..."));
                }
                return [2 /*return*/];
            });
        });
